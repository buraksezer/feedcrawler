...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeedUserRelation'
        db.create_table(u'accounts_feeduserrelation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('feed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.Feed'])),
            ('show_on_stream', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'accounts', ['FeedUserRelation'])


    def backwards(self, orm):
        # Deleting model 'FeedUserRelation'
        db.delete_table(u'accounts_feeduserrelation')


    models = {
        u'accounts.feeduserrelation': {
            'Meta': {'object_name': 'FeedUserRelation'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['storage.Feed']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'show_on_stream': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
