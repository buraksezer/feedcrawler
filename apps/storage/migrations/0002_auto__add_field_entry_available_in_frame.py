...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.available_in_frame'
        db.add_column(u'storage_entry', 'available_in_frame',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.available_in_frame'
        db.delete_column(u'storage_entry', 'available_in_frame')
