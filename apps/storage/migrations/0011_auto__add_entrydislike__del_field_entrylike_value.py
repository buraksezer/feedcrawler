...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EntryLike.value'
        db.delete_column(u'storage_entrylike', 'value')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'EntryLike.value'
        raise RuntimeError("Cannot reverse this migration. 'EntryLike.value' and its values cannot be restored.")
