...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'storage_entry', 'title', self.gf('django.db.models.fields.CharField')(max_length=2048))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Entry.title'
        db.alter_column(u'storage_entry', 'title', self.gf('django.db.models.fields.CharField')(max_length=1024))
