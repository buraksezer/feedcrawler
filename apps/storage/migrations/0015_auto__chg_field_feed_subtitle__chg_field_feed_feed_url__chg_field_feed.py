...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feed.subtitle'
        db.alter_column(u'storage_feed', 'subtitle', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

        # Changing field 'Feed.feed_url'
        db.alter_column(u'storage_feed', 'feed_url', self.gf('django.db.models.fields.TextField')(unique=True))

        # Changing field 'Feed.hub'
        db.alter_column(u'storage_feed', 'hub', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Feed.title'
        db.alter_column(u'storage_feed', 'title', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

        # Changing field 'Feed.encoding'
        db.alter_column(u'storage_feed', 'encoding', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

        # Changing field 'Feed.language'
        db.alter_column(u'storage_feed', 'language', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'Feed.link'
        db.alter_column(u'storage_feed', 'link', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

        # Changing field 'Feed.image'
        db.alter_column(u'storage_feed', 'image', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

    def backwards(self, orm):

        # Changing field 'Feed.subtitle'
        db.alter_column(u'storage_feed', 'subtitle', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'Feed.feed_url'
        db.alter_column(u'storage_feed', 'feed_url', self.gf('django.db.models.fields.CharField')(max_length=512, unique=True))

        # Changing field 'Feed.hub'
        db.alter_column(u'storage_feed', 'hub', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'Feed.title'
        db.alter_column(u'storage_feed', 'title', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Feed.encoding'
        db.alter_column(u'storage_feed', 'encoding', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Feed.language'
        db.alter_column(u'storage_feed', 'language', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Feed.link'
        db.alter_column(u'storage_feed', 'link', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'Feed.image'
        db.alter_column(u'storage_feed', 'image', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
