...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'RepostEntry', fields ['slug']
        db.delete_unique(u'storage_repostentry', ['slug'])

        # Removing unique constraint on 'RepostEntry', fields ['entry_id']
        db.delete_unique(u'storage_repostentry', ['entry_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'RepostEntry', fields ['entry_id']
        db.create_unique(u'storage_repostentry', ['entry_id'])

        # Adding unique constraint on 'RepostEntry', fields ['slug']
        db.create_unique(u'storage_repostentry', ['slug'])
    ...
    models = {
        ...
        u'storage.repostentry': {
            ...
            u'baseentry_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['storage.BaseEntry']", 'unique': 'True', 'primary_key': 'True'}),
            'entry_id': ('django.db.models.fields.URLField', [], {'max_length': '2048'}),
            'note': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'origin_id': ('django.db.models.fields.BigIntegerField', [], {}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'max_length': '50', 'unique_with': '()', 'null': 'True', 'populate_from': "'title'"})
        }
    }
