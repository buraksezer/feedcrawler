...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'storage_entry', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique=True, null=True, populate_from='title', unique_with=()),
                      keep_default=False)


        # Changing field 'Entry.entry_id'
        db.alter_column(u'storage_entry', 'entry_id', self.gf('django.db.models.fields.URLField')(unique=True, max_length=2048))

        # Changing field 'Entry.link'
        db.alter_column(u'storage_entry', 'link', self.gf('django.db.models.fields.URLField')(max_length=2048))
        # Adding field 'Feed.slug'
        db.add_column(u'storage_feed', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique=True, null=True, populate_from='title', unique_with=()),
                      keep_default=False)
        ...
        db.add_column(u'storage_list', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique=True, null=True, populate_from='title', unique_with=()),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Entry.entry_id'
        db.alter_column(u'storage_entry', 'entry_id', self.gf('django.db.models.fields.URLField')(max_length=512, unique=True))

        # Changing field 'Entry.link'
        db.alter_column(u'storage_entry', 'link', self.gf('django.db.models.fields.URLField')(max_length=512))
        # Deleting field 'Feed.slug'
        db.delete_column(u'storage_feed', 'slug')


        # Changing field 'Feed.title'
        db.alter_column(u'storage_feed', 'title', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
        # Deleting field 'List.slug'
        db.delete_column(u'storage_list', 'slug')
    ...
    models = {
        ...
        u'storage.list': {
            'Meta': {'ordering': "['-id']", 'object_name': 'List'},
            'feed': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['storage.Feed']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'max_length': '50', 'unique': 'True', 'null': 'True', 'populate_from': "'title'", 'unique_with': '()'}),
