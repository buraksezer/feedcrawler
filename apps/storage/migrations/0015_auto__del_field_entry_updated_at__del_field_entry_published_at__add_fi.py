...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Entry.updated_at'
        db.delete_column(u'storage_entry', 'updated_at')

        # Deleting field 'Entry.published_at'
        db.delete_column(u'storage_entry', 'published_at')

        # Adding field 'Entry.author_email'
        db.add_column(u'storage_entry', 'author_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'Entry.date_modified'
        db.add_column(u'storage_entry', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Entry.updated_at'
        db.add_column(u'storage_entry', 'updated_at',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Entry.published_at'
        db.add_column(u'storage_entry', 'published_at',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Deleting field 'Entry.author_email'
        db.delete_column(u'storage_entry', 'author_email')

        # Deleting field 'Entry.date_modified'
        db.delete_column(u'storage_entry', 'date_modified')
