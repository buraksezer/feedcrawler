...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.published_at'
        db.alter_column(u'storage_entry', 'published_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 14, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Entry.published_at'
        db.alter_column(u'storage_entry', 'published_at', self.gf('django.db.models.fields.DateField')(null=True))
