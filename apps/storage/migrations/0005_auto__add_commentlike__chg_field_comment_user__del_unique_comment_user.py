...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Comment', fields ['entry']
        db.delete_unique(u'storage_comment', ['entry_id'])

        # Removing unique constraint on 'Comment', fields ['user']
        db.delete_unique(u'storage_comment', ['user_id'])

        # Adding model 'CommentLike'
        db.create_table(u'storage_commentlike', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['storage.Comment'], unique=True)),
        ))
        db.send_create_signal(u'storage', ['CommentLike'])

        # Adding M2M table for field user on 'CommentLike'
        db.create_table(u'storage_commentlike_user', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('commentlike', models.ForeignKey(orm[u'storage.commentlike'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'storage_commentlike_user', ['commentlike_id', 'user_id'])


        # Changing field 'Comment.user'
        db.alter_column(u'storage_comment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Comment.entry'
        db.alter_column(u'storage_comment', 'entry_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.Entry']))

    def backwards(self, orm):
        # Deleting model 'CommentLike'
        db.delete_table(u'storage_commentlike')

        # Removing M2M table for field user on 'CommentLike'
        db.delete_table('storage_commentlike_user')


        # Changing field 'Comment.user'
        db.alter_column(u'storage_comment', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Comment', fields ['user']
        db.create_unique(u'storage_comment', ['user_id'])


        # Changing field 'Comment.entry'
        db.alter_column(u'storage_comment', 'entry_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['storage.Entry'], unique=True))
        # Adding unique constraint on 'Comment', fields ['entry']
        db.create_unique(u'storage_comment', ['entry_id'])
    ...
    models = {
        ...
        u'storage.commentlike': {
            'Meta': {'object_name': 'CommentLike'},
            'comment': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['storage.Comment']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
