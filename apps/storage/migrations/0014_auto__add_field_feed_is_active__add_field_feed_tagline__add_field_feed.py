...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'storage_feed', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Feed.tagline'
        db.add_column(u'storage_feed', 'tagline',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Feed.etag'
        db.add_column(u'storage_feed', 'etag',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'storage_feed', 'is_active')

        # Deleting field 'Feed.tagline'
        db.delete_column(u'storage_feed', 'tagline')

        # Deleting field 'Feed.etag'
        db.delete_column(u'storage_feed', 'etag')
