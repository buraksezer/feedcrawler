...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'storage_entry', 'content')


    def backwards(self, orm):
        # Adding field 'Entry.content'
        db.add_column(u'storage_entry', 'content',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2013, 3, 31, 0, 0)),
                      keep_default=False)
