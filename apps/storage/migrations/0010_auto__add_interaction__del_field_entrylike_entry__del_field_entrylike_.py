...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EntryLike.entry'
        db.delete_column(u'storage_entrylike', 'entry_id')

        # Deleting field 'EntryLike.created_at'
        db.delete_column(u'storage_entrylike', 'created_at')

        # Deleting field 'EntryLike.id'
        db.delete_column(u'storage_entrylike', u'id')

        # Deleting field 'EntryLike.user'
        db.delete_column(u'storage_entrylike', 'user_id')

        # Adding field 'EntryLike.interaction_ptr'
        db.add_column(u'storage_entrylike', u'interaction_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['storage.Interaction'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'Comment.created_at'
        db.delete_column(u'storage_comment', 'created_at')

        # Deleting field 'Comment.user'
        db.delete_column(u'storage_comment', 'user_id')

        # Deleting field 'Comment.entry'
        db.delete_column(u'storage_comment', 'entry_id')

        # Deleting field 'Comment.id'
        db.delete_column(u'storage_comment', u'id')

        # Adding field 'Comment.interaction_ptr'
        db.add_column(u'storage_comment', u'interaction_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['storage.Interaction'], unique=True, primary_key=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'EntryLike.entry'
        db.add_column(u'storage_entrylike', 'entry',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['storage.Entry']),
                      keep_default=False)

        # Adding field 'EntryLike.created_at'
        db.add_column(u'storage_entrylike', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 7, 5, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'EntryLike.id'
        db.add_column(u'storage_entrylike', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Adding field 'EntryLike.user'
        db.add_column(u'storage_entrylike', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'EntryLike.interaction_ptr'
        db.delete_column(u'storage_entrylike', u'interaction_ptr_id')

        # Adding field 'Comment.created_at'
        db.add_column(u'storage_comment', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 7, 5, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Comment.user'
        db.add_column(u'storage_comment', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Comment.entry'
        db.add_column(u'storage_comment', 'entry',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['storage.Entry']),
                      keep_default=False)

        # Adding field 'Comment.id'
        db.add_column(u'storage_comment', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Deleting field 'Comment.interaction_ptr'
        db.delete_column(u'storage_comment', u'interaction_ptr_id')
